          ...
          <td width="50%">
            <div class='mb-3'>
              ...
              <input type='text' class='form-control' id='requestedDate' name='requestedDate'
                placeholder='Format: yyyy-mm-dd' pattern="\d{4}-\d{1,2}-\d{1,2}" value="" />
            </div>
          </td>
          <td>
            <div class='mb-3'>
              Room Number:
              <input type='text' class='form-control' id='roomNo' name='roomNo' value="" />
            </div>
          </td>
        </tr>
        <tr>
          <td colspan=2>
            <div class='mb-3'>
              Requested by:
              <input type='text' class='form-control' id='requestedBy' name='requestedBy' placeholder='Enter your name'
                value="" />
            </div>
          </td>
        </tr>
        <tr>
          <td colspan=2>
            <div class="mb-3">
              ...
              <input type='text' class='form-control' id='requestDesc' name='requestDesc' value="" />
            </div>
          </td>
        </tr>
        <tr>
